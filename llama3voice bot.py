        ...
        with mic as source:            
            ...
            try: 
                ...
                if sleeping == True:
                    ...
                    if "walter" in text.lower():
                        request = text.lower().split("walter")[1]
                        ...
                        if len(request) < 2:
                            ...
                            append2log(f"Walter White: Hi, there, how can I help? \n")
                            continue                      
                ...
                # AI is awake         
                    ...
                    if "that's all" in request:
                        ...
                        append2log(f"Walter White: Bye now. \n")                        
